...
|Name Tag|Search for barrel items containing a name tag, and apply each name tag to its barrel. This avoids the need to manually rename preset barrels after modifying them.|This trigger causes all other triggers to be ignored.|
